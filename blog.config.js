...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '2498a76030d981a4907d000c6d7a5a81',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '代码玩家 & 终身学习者', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '在代码的世界里打怪升级，在知识的海洋里冲浪探险。🌊', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://your-cool-site.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '前端, 后端, 全栈, JavaScript, Python, 算法, 设计模式, 终身学习', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '你好，世界！我是代码的魔法师。✨,今天你Debug了吗？欢迎来到我的学习乐园！,敲代码，品生活，做一个有趣的终身学习者。,欢迎光临！这里是我的数字花园，正在茁壮成长。🌱',
